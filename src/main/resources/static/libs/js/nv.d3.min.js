...
nv.models.tooltip = function() {
    ...
    */
    ...
    var positionTooltip = function() {
	    ...
	    var popup = document.getElementsByClassName('md-dialog-container');
	    var offset = window.pageYOffset;
		if(popup && popup[0]) {
			offset = popup[0].offsetTop;
		}

            var pos = position(),
                gravityOffset = calcGravityOffset(pos),
                left = pos.left + gravityOffset.left,
                top = pos.top + gravityOffset.top + offset;
            ...
            areaPaths.enter().append('path')
                ...
                .attr('d', function(d) {
                    return d3.svg.area()
                        ...
                        .y1(function(d,i) { 
				var y1 = nv.utils.NaNtoZero(y0(getY1(d,i)));
				if(y1) {
					return y1;
				}
