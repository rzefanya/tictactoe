(function($, moment)
{
	...
	Plugin.prototype = 
	{
		...
		isAfterMinDate: function(date, checkHour, checkMinute, x)
		{
			var _return = true;
		...
		isBeforeMaxDate: function(date, checkTime, checkMinute, x)
		{
			var _return = true;
		...
		toggleButtons: function(date)
		{
			if(date && date.isValid())
			{
				...
				if(!this.isAfterMinDate(startOfMonth, false, false, true))
				{
				...
				if(!this.isBeforeMaxDate(endOfMonth, false, false, true))
				{
				...
				if(!this.isAfterMinDate(startOfYear, false, false, true))
				{
				...
				if(!this.isBeforeMaxDate(endOfYear, false, false, true))
				{
